...
function App() {
  ...
  useEffect(() => {
    ...
    if (filters.maxDuration) {
      filtered = filtered.filter(f => f.duration <= parseFloat(filters.maxDuration));
    }
        ...
        <Row>
          ...
          <Col lg={4} className="mb-4">
            <div className="sticky-top" style={{ top: '80px' }}>
              ...
              <Form className="mt-3 p-3 bg-light rounded border shadow-sm">
                <Form.Label className="fw-bold">Sort By</Form.Label>
                <Form.Select value={sortBy} onChange={e => setSortBy(e.target.value)} className="mb-2">
